...
Syskit.conf.use_deployment TelemetryProvider::FIPAPublisher => "#{Roby.app.robot_name}__fipa_publisher"
Syskit.conf.use_deployment TelemetryProvider::FIPASubscriber => "#{Roby.app.robot_name}__fipa_subscriber"
